...
class CellTest < Minitest::Test
  ...
  def test_cell_recognizes_ship_placed_in_it_and_is_not_empty
  ...
  def test_ship_in_cell_loses_health_when_fired_upon
    @cell_1.place_ship(@cruiser)
    @cell_1.fire_upon
  ...
  def test_render_true_if_cell_is_empty_when_fired_upon
    @cell_1.fire_upon
    assert_equal true, @cell_1.empty?
    assert_equal "M", @cell_1.render(true)
  end

  def test_render_true_if_cell_has_a_ship_when_fired_upon
    @cell_2.place_ship(@cruiser)
    @cell_2.fire_upon
    assert_equal false, @cell_2.empty?
    assert_equal false, @cell_2.ship.sunk?
  ...
  def test_render_true_if_cell_has_a_ship_that_sinks_when_fired_upon
    @cell_2.place_ship(@cruiser)
    @cell_2.fire_upon
    @cell_2.ship.hit
    @cell_2.ship.hit
